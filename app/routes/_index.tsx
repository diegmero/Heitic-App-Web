...
<motion.main
      ...
      >
        ...
        <div className="flex flex-col sm:flex-col lg:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
          ...
          <Link
            to="/contacto"
            className="bg-transparent border-2 border-white text-white px-2 py-3 rounded-full font-bold text-base sm:text-lg hover:bg-white hover:text-blue-600 transition duration-300 w-full sm:w-auto text-center"
          >
            Contáctanos
          </Link>
        </div>
